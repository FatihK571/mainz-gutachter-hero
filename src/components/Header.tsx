      ...
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/80 backdrop-blur-md shadow-sm">
        <div className="container mx-auto px-4">
          <div className="flex h-16 items-center justify-between">
            ...
            <a 
              href="#" 
              className="flex items-center gap-2 font-bold text-lg text-foreground hover:text-primary transition-colors focus-ring rounded-md px-2 py-1"
              onClick={(e) => {
                e.preventDefault();
            ...
            >
              ...
              <span className="hidden sm:inline">KFZ-Gutachter</span>
            </a>
